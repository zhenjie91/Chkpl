                ...
                <div class="table-responsive">
                    <table style="width: 100%" class="table-striped">
                        ...
                        <tr>
                            ...
                            <td style="padding-right: 20px;">
                                <div class="pull-right">
                                    <a class="btn-xs btn-info" data-toggle="modal" data-tskTitle="<%=t2[0]%>" data-tskDetails="<%=t2[1]%>" data-id="task2" href="#editModal"><span class="fui-info-circle"></span> Details</a>
                                </div>
                            </td>
                        </tr>
                        <%}
